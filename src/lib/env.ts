...
export interface Env {
  OPENMAILSDK_BEARER_AUTH?: string | undefined;

  OPENMAILSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  OPENMAILSDK_BEARER_AUTH: z.optional(z.string()),

  OPENMAILSDK_DEBUG: z.optional(z.coerce.boolean()),
});
